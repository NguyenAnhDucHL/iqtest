...
public class IqTestSettingController {
    ...
    public ResponseEntity<IqTestSettingDTO> updateSetting(@PathVariable("id") @Parameter(description = "ID of the setting to be updated") String id, @RequestBody IqTestSettingDTO settingDto) {
    ...
    public ResponseEntity<Void> deleteSettingByTestSettingId(@PathVariable("testSettingId") @Parameter(description = "ID of the setting to be deleted") String testSettingId) {
    ...
    public ResponseEntity<IqTestSettingDTO> getSettingById(@PathVariable("id") @Parameter(description = "ID of the setting") String id) {
