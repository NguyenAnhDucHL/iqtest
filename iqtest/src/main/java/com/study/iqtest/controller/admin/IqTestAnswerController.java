...
public class IqTestAnswerController {
    ...
    public ResponseEntity<IqTestAnswerDTO> updateAnswer(@PathVariable("id") @Parameter(description = "ID of the answer to be updated") String id, @RequestBody IqTestAnswerDTO answerDTO) {
    ...
    public ResponseEntity<Void> deleteAnswer(@PathVariable("id") @Parameter(description = "ID of the answer to be deleted") String id) {
    ...
    public ResponseEntity<List<IqTestAnswerDTO>> getAnswersByQuestionId(@PathVariable("questionId") @Parameter(description = "ID of the question for which answers are needed") String questionId) {
